...
namespace GeoTiffToInf {
    ...
    class GeoTiff : ViewModelBase {
        ...
        public double LEFT_LONG {
            ...
            set { SetField(ref _LEFT_LONG, value); }
        }
        public double TOP_LAT {
            get { return _TOP_LAT; }
            set { SetField(ref _TOP_LAT, value); }
        }
        public double dXScale {
            get { return _dXScale; }
            set { SetField(ref _dXScale, value); }
        }
        public double dYScale {
            get { return _dYScale; }
            set { SetField(ref _dYScale, value); }
        }

        public UInt16 GEOMODEL {
            get { return _GEOMODEL; }
            set { SetField(ref _GEOMODEL, value); }
        }
        public UInt16 GEORASTER {
            get { return _GEORASTER; }
            set { SetField(ref _GEORASTER, value); }
        }
        public UInt16 GeographicType {
            get { return _GeographicType; }
            set { SetField(ref _GeographicType, value); }
        }
        public UInt16 GeogAngularUnits {
            get { return _GeogAngularUnits; }
            set { SetField(ref _GeogAngularUnits, value); }
        }
        ...
        public GeoTiff() {
            ImageWidth = 0; //pixels
            ImageHeight = 0; //pixels
            LEFT_LONG = 0; //map coords
            TOP_LAT = 0; //map coords
            dXScale = 0; //degs/pixel
            dYScale = 0; //degs/pixel
            ...
            if (ifdData != null) {
                switch (tag) {
                    case (int)EXIFTags.ImageWidth: {
                            ...
                            if (ifdData.GetType() != typeof(UInt16)) throw new Exception("Unexpected type in tag.");
                    ...
                    case (int)EXIFTags.PixelScale: {
                            if (ifdData.GetType() != typeof(double[])) throw new Exception("Unexpected type in tag.");
